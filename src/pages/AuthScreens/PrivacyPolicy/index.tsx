  ...
  return (
    <>
      ...
      <div className="relative bg-gray-50 text-gray-800 font-sans">
        ...
        {/* Banner */}
        <section
          className="py-12 px-4 flex flex-col items-center justify-center relative z-10 text-white bg-[#0B0D18] "
        //   style={{
        ...
        {/* Content */}
          ...
          <section className="relative z-10 max-w-5xl mx-auto p-6 space-y-8 bg-[#0B0D18]" >
          <div>
